...
public class Main {
    ...
    private static final String SQL_CREATE_TABLE = "DROP TABLE IF EXISTS empregado; " +
            ...
            "empresa varchar(64)," +
            "idade int not null, data_inicio varchar(32) not null);";
        ...
        try {
            ...
            while (rs.next()) {
                System.out.println(rs.getInt(1) + " | " +
                        ...
                        rs.getString(3) + " | " +
                        rs.getInt(4) + " | " +
                        rs.getString(5)); //respeitar os strings e ints de cada dado
            }
    ...
    public static Connection getConnection() throws Exception {
        return DriverManager.getConnection("jdbc:h2:mem:alula11", "sa", "");
    }// aula11 é o banco de dados que esá sendo criado
